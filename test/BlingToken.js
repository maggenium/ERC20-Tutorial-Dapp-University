...
contract('BlingToken', function(accounts) {
    ...
    it('initializes the contract with the correct values', function() {
        return BlingToken.deployed().then(function(instance) {
            ...
            assert.equal(name, 'Bling Token', 'has the correct name');
        });
    });
    ...
    it('allocates the initial supply upon deployment', function() {
        return BlingToken.deployed().then(function(instance) {
            ...
            assert.equal(symbol, 'BLNG', 'has the correct symbol');
            return tokenInstance.standard();
        }).then(function(standard) {
            assert.equal(standard, 'Bling Token v1.0', 'has the correct standard');
        });
    });
    ...
    it('transfers token ownership', function() {
        return BlingToken.deployed().then(function(instance) {
            tokenInstance = instance;
            // Test 'require' statement first by trasferring something larger than the sender's balance
